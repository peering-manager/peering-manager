...
AUTH_BACKEND_ATTRS = {
    "amazon": ("Amazon AWS", "fa-aws"),
    "apple": ("Apple", "fa-apple"),
    "auth0": ("Auth0", None),
    "azuread-oauth2": ("Microsoft Azure AD", "fa-microsoft"),
    "azuread-b2c-oauth2": ("Microsoft Azure AD", "fa-microsoft"),
    "azuread-tenant-oauth2": ("Microsoft Azure AD", "fa-microsoft"),
    "azuread-v2-tenant-oauth2": ("Microsoft Azure AD", "fa-microsoft"),
    "bitbucket": ("BitBucket", "fa-bitbucket"),
    "bitbucket-oauth2": ("BitBucket", "fa-bitbucket"),
    "digitalocean": ("DigitalOcean", "fa-digital-ocean"),
    "docker": ("Docker", "fa-docker"),
    "github": ("GitHub", "fa-github"),
    "github-app": ("GitHub", "fa-github"),
    "github-org": ("GitHub", "fa-github"),
    "github-team": ("GitHub", "fa-github"),
    "github-enterprise": ("GitHub Enterprise", "fa-github"),
    "github-enterprise-org": ("GitHub Enterprise", "fa-github"),
    "github-enterprise-team": ("GitHub Enterprise", "fa-github"),
    "gitlab": ("GitLab", "fa-gitlab"),
    "google-oauth2": ("Google", "fa-google"),
    "google-openidconnect": ("Google", "fa-google"),
    "hubspot": ("HubSpot", "fa-hubspot"),
    "keycloak": ("Keycloak", None),
    "microsoft-graph": ("Microsoft Graph", "fa-microsoft"),
    "oidc": ("OpenID Connect", "fa-openid"),
    "okta": ("Okta", None),
    "okta-openidconnect": ("Okta (OIDC)", None),
    "salesforce-oauth2": ("Salesforce", "fa-salesforce"),
}
