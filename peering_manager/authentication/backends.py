...
AUTH_BACKEND_ATTRS = {
    "amazon": ("Amazon AWS", "fa-brands fa-aws"),
    "apple": ("Apple", "fa-brands fa-apple"),
    "auth0": ("Auth0", None),
    "azuread-oauth2": ("Microsoft Azure AD", "fa-brands fa-microsoft"),
    "azuread-b2c-oauth2": ("Microsoft Azure AD", "fa-brands fa-microsoft"),
    "azuread-tenant-oauth2": ("Microsoft Azure AD", "fa-brands fa-microsoft"),
    "azuread-v2-tenant-oauth2": ("Microsoft Azure AD", "fa-brands fa-microsoft"),
    "bitbucket": ("BitBucket", "fa-brands fa-bitbucket"),
    "bitbucket-oauth2": ("BitBucket", "fa-brands fa-bitbucket"),
    "digitalocean": ("DigitalOcean", "fa-brands fa-digital-ocean"),
    "docker": ("Docker", "fa-brands fa-docker"),
    "github": ("GitHub", "fa-brands fa-github"),
    "github-app": ("GitHub", "fa-brands fa-github"),
    "github-org": ("GitHub", "fa-brands fa-github"),
    "github-team": ("GitHub", "fa-brands fa-github"),
    "github-enterprise": ("GitHub Enterprise", "fa-brands fa-github"),
    "github-enterprise-org": ("GitHub Enterprise", "fa-brands fa-github"),
    "github-enterprise-team": ("GitHub Enterprise", "fa-brands fa-github"),
    "gitlab": ("GitLab", "fa-brands fa-gitlab"),
    "google-oauth2": ("Google", "fa-brands fa-google"),
    "google-openidconnect": ("Google", "fa-brands fa-google"),
    "hubspot": ("HubSpot", "fa-brands fa-hubspot"),
    "keycloak": ("Keycloak", None),
    "microsoft-graph": ("Microsoft Graph", "fa-brands fa-microsoft"),
    "oidc": ("OpenID Connect", "fa-brands fa-openid"),
    "okta": ("Okta", None),
    "okta-openidconnect": ("Okta (OIDC)", None),
    "salesforce-oauth2": ("Salesforce", "fa-brands fa-salesforce"),
}
