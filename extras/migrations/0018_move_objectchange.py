...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            database_operations=[
                migrations.AlterModelTable(name="ObjectChange", table="core_objectchange"),
                # PK sequence
                ...
                migrations.RunSQL("ALTER TABLE extras_objectchange_pkey RENAME TO core_objectchange_pkey"),
                migrations.RunSQL(
