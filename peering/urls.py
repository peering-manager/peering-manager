...
urlpatterns = [
    # Autonomous Systems
    url(r'^autonomous-systems/$', views.ASList.as_view(),
        name='autonomous_system_list'),
    url(r'^autonomous-systems/add/$', views.ASAdd.as_view(),
        name='autonomous_system_add'),
    url(r'^autonomous-systems/import/$',
        views.ASImport.as_view(), name='autonomous_system_import'),
    url(r'^autonomous-systems/import_from_peeringdb/$',
        views.ASImportFromPeeringDB.as_view(),
        name='autonomous_system_import_from_peeringdb'),
    url(r'^autonomous-systems/(?P<asn>[0-9]+)/$',
        views.ASDetails.as_view(), name='autonomous_system_details'),
    url(r'^autonomous-systems/(?P<asn>[0-9]+)/edit/$',
        views.ASEdit.as_view(), name='autonomous_system_edit'),
    url(r'^autonomous-systems/(?P<asn>[0-9]+)/delete/$',
        views.ASDelete.as_view(), name='autonomous_system_delete'),
    url(r'^autonomous-systems/delete/$',
        views.ASBulkDelete.as_view(), name='autonomous_system_bulk_delete'),
    url(r'^autonomous-systems/(?P<asn>[0-9]+)/sync/$',
        views.ASPeeringDBSync.as_view(),
        name='autonomous_system_peeringdb_sync'),
    url(r'^autonomous-systems/(?P<asn>[\w-]+)/direct-peering-sessions/$',
        views.AutonomousSystemDirectPeeringSessions.as_view(),
        name='autonomous_system_direct_peering_sessions'),
    url(r'^autonomous-systems/(?P<asn>[\w-]+)/ix-peering-sessions/$',
    ...
    url(r'^communities/$', views.CommunityList.as_view(),
        name='community_list'),
    url(r'^communities/add/$', views.CommunityAdd.as_view(),
        name='community_add'),
    url(r'^communities/import/$', views.CommunityImport.as_view(),
        name='community_import'),
    url(r'^communities/(?P<pk>[0-9]+)/$', views.CommunityDetails.as_view(),
        name='community_details'),
    url(r'^communities/(?P<pk>[0-9]+)/edit/$', views.CommunityEdit.as_view(),
        name='community_edit'),
    url(r'^communities/(?P<pk>[0-9]+)/delete/$',
    ...
    url(r'^templates/add/$', views.ConfigTemplateAdd.as_view(),
        name='configuration_template_add'),
    url(r'^templates/(?P<pk>[0-9]+)/$', views.ConfigTemplateDetails.as_view(),
    ...
    url(r'^internet-exchanges/add/$', views.IXAdd.as_view(),
        name='internet_exchange_add'),
    url(r'^internet-exchanges/import/$',
        views.IXImport.as_view(), name='internet_exchange_import'),
    url(r'^internet-exchanges/peeringdb-import/$',
    ...
    url(r'^internet-exchanges/(?P<slug>[\w-]+)/delete/$',
        views.IXDelete.as_view(), name='internet_exchange_delete'),
    url(r'^internet-exchanges/(?P<slug>[\w-]+)/add-peering-session/$',
    ...
    url(r'^routers/import/$', views.RouterImport.as_view(),
        name='router_import'),
    url(r'^routers/(?P<pk>[0-9]+)/$', views.RouterDetails.as_view(),
        name='router_details'),
    url(r'^routers/(?P<pk>[0-9]+)/edit/$', views.RouterEdit.as_view(),
        name='router_edit'),
    url(r'^routers/(?P<pk>[0-9]+)/delete/$', views.RouterDelete.as_view(),
        name='router_delete'),
