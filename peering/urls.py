...
urlpatterns = [
    ...
    url(r'^as/(?P<asn>[0-9]+)/$', views.ASDetails.as_view(),
        name='as_details'),
    ...
    url(r'^as/(?P<asn>[0-9]+)/sync/$', views.ASPeeringDBSync.as_view(),
        name='as_peeringdb_sync'),
    url(r'^as/(?P<asn>[\w-]+)/sessions/$', views.ASPeeringSessions.as_view(),
        name='as_peering_sessions'),
    ...
    url(r'^peering/add_from_peeringdb/$',
        views.PeeringSessionAddFromPeeringDB.as_view(),
        name='peering_session_add_from_peeringdb'),
