...
urlpatterns = [
    ...
    url(r'^as/delete/$', views.ASBulkDelete.as_view(), name='as_bulk_delete'),
    ...
    url(r'^community/(?P<pk>[0-9]+)/edit/$',
        views.CommunityEdit.as_view(), name='community_edit'),
    url(r'^community/(?P<pk>[0-9]+)/delete/$',
        views.CommunityDelete.as_view(), name='community_delete'),
    url(r'^community/delete/$', views.CommunityBulkDelete.as_view(),
    ...
    url(r'^ix/delete/$', views.IXBulkDelete.as_view(), name='ix_bulk_delete'),
    url(r'^ix/(?P<slug>[\w-]+)/$',
    ...
    url(r'^router/(?P<pk>[0-9]+)/delete/$',
        views.RouterDelete.as_view(), name='router_delete'),
    url(r'^router/delete/$', views.RouterBulkDelete.as_view(),
