...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='router',
            name='platform',
            field=models.CharField(blank=True, choices=[('junos', 'Juniper JUNOS'), ('iosxr', 'Cisco IOS-XR'), (None, 'Other')], help_text='The router platform, used to interact with it', max_length=50),
        ),
        migrations.AddField(
