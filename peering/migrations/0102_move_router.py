...
def update_content_types(apps, schema_editor):
    ...
    ContentType.objects.filter(app_label="peering", model="router").update(app_label="devices")
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            database_operations=[
                ...
                # PK sequence
                migrations.RunSQL("ALTER TABLE peering_router_id_seq RENAME TO devices_router_id_seq"),
                # Indexes (hashes generated by schema_editor._create_index_name)
                migrations.RunSQL("ALTER INDEX peering_router_pkey RENAME TO devices_router_pkey"),
                migrations.RunSQL(
                    "ALTER INDEX peering_router_configuration_id_03b43e8c "
                    "RENAME TO devices_router_configuration_id_55b09a38"
                ),
                migrations.RunSQL(
                    "ALTER INDEX peering_router_data_file_id_56f9f429 RENAME TO devices_router_data_file_id_0e63d3ae"
                ),
                migrations.RunSQL(
                ...
                migrations.RunSQL(
                    "ALTER INDEX peering_router_platform_id_55d3f646 RENAME TO devices_router_platform_id_b503339f"
                ),
                # Constraints
                migrations.RunSQL(
                ...
                migrations.RunSQL(
                    "ALTER TABLE devices_router DROP CONSTRAINT IF EXISTS peering_router_platform_id_55d3f646_fk"
                ),
                migrations.RunSQL(
                    "ALTER TABLE devices_router "
