...
def update_content_types(apps, schema_editor):
    ...
    ContentType.objects.filter(app_label="peering", model="community").update(app_label="bgp")
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            database_operations=[
                ...
                # PK sequence
                migrations.RunSQL("ALTER TABLE peering_community_id_seq RENAME TO bgp_community_id_seq"),
                # Indexes (hashes generated by schema_editor._create_index_name)
                migrations.RunSQL("ALTER INDEX peering_community_pkey RENAME TO bgp_community_pkey"),
                migrations.RunSQL(
                    "ALTER INDEX peering_community_name_9e062f52_uniq RENAME TO bgp_community_name_9e062f52_uniq"
                ),
                migrations.RunSQL(
                    "ALTER INDEX peering_community_slug_7a8117c2_uniq RENAME TO bgp_community_slug_7a8117c2_uniq"
                ),
            ],
            state_operations=[
